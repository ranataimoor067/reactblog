    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 z-50">
          <div
            className={`relative w-full max-w-sm p-8 rounded-lg shadow-lg ${
            ...
            >
              <input
                ...
                className={`w-full p-2.5 rounded-lg border ${
                  loginCredential ? "border-green-500" : "border-gray-300"
              ...
              {!isLogin && (
                <>
                  ...
                  <input
                    ...
                    required
                    className={`w-full p-2.5 rounded-lg border ${
                      name ? "border-green-500" : "border-gray-300"
                    } focus:ring-2 focus:ring-green-500 focus:outline-none ${
                      theme === "dark"
                        ? "bg-gray-700 text-white"
                        : "text-gray-700"
                  ...
                  <input
                    ...
                    className={`w-full p-2.5 rounded-lg border ${
                      picture ? "border-green-500" : "border-gray-300"
                    } focus:ring-2 focus:ring-green-500 focus:outline-none ${
                      theme === "dark"
                        ? "bg-gray-700 text-white"
                        : "text-gray-700"
                  ...
                  <input
                    ...
                    className={`w-full p-2.5 rounded-lg border ${
                      dob ? "border-green-500" : "border-gray-300"
                    } focus:ring-2 focus:ring-green-500 focus:outline-none ${
                      theme === "dark"
                        ? "bg-gray-700 text-white"
                        : "text-gray-700"
