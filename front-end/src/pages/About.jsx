...
const About = () => {
  ...
  const features = [
    {
      ...
      description: 'Join a vibrant community of writers and readers who share your love for storytelling.'
    },
    {
      icon: <Users className="w-6 h-6" />,
      title: 'Diverse Perspectives',
      description: 'Experience stories and insights from writers across different cultures and backgrounds.'
    },
    {
      icon: <Sparkles className="w-6 h-6" />,
      title: 'Creative Freedom',
      description: 'Express yourself freely with our powerful and intuitive writing tools.'
    },
    {
      icon: <BookOpen className="w-6 h-6" />,
      title: 'Knowledge Exchange',
      description: 'Learn and grow through shared experiences and collaborative learning.'
    }
  ];
  ...
  const tabContent = {
    mission: {
      title: 'Our Mission',
      content: 'To create a global platform where every voice matters and every story finds its audience. We\'re dedicated to fostering a community where creativity thrives and writers can grow.'
    },
    vision: {
      title: 'Our Vision',
      content: 'To become the world\'s most inclusive and innovative platform for digital storytelling, where technology meets creativity to empower writers of all backgrounds.'
    },
    values: {
      title: 'Our Values',
      content: 'We believe in authenticity, diversity, creativity, and the power of community. These principles guide everything we do, from feature development to community management.'
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-blue-50 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 py-20 relative">
          <div className={`text-center transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Empowering voices, connecting minds, and inspiring creativity through the art of storytelling.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="md:flex items-center gap-12">
          {/* Left Side */}
          <div className={`md:w-1/2 transform transition-all duration-1000 delay-300 ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'}`}>
          ...
          {/* Right Side */}
          <div className={`md:w-1/2 mt-12 md:mt-0 transform transition-all duration-1000 delay-500 ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0'}`}>
            {/* Tabs */}
      ...
      <div className="max-w-7xl mx-auto px-4 ">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <div
              key={feature.title}
              className={`bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg transform transition-all duration-500 hover:scale-105 hover:shadow-xl
      ...
      {/* CTA Section */}
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className={`bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-12 text-center text-white transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
