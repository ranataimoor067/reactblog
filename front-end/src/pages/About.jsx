...
function About() {
  return (
    <div className="w-full bg-gray-50 dark:bg-gray-900 py-44">
      <div className="max-w-7xl mx-auto md:flex items-center justify-between">
        ...
        <div className="md:w-1/2 text-center md:text-left">
          <h2 className="text-5xl font-extrabold mb-6 text-blue-800 dark:text-blue-400">About Us</h2>
          <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
            Welcome to <span className="font-semibold text-blue-800 dark:text-blue-400">React Blog</span>, your go-to platform for creative expression. 
